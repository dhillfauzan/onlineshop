    ...
    <div class="col-md-12"> 
        <div class="billing-details"> 
            ...
            <div class="row"> 
                ...
                <form action="{{ route('customer.updateakun', $edit->id) }}" method="post" enctype="multipart/form-data"> 
                    @method('put') 
                    @csrf 
                    ...
                    <div class="col-md-4"> 
                        <div class="form-group"> 
                            ...
                            @if ($edit->foto) 
                            <img src="{{ asset('storage/img-customer/' . $edit->foto) }}" class="foto-preview" width="100%"> 
                            <p></p> 
                            @else 
