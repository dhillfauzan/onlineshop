...
@error('kategori_id') is-invalid @enderror">
                                        ...
                                        @foreach ($kategori as $row)
                                                                                    @if (
                                                                                            old('kategori_id', $edit->kategori_id) ==
                                                                                            $row->id
                                                                                        )
    ...
    old('nama_produk', $edit->nama_produk) }}" class="form-control @error('nama_produk') isinvalid @enderror"
...
@error('harga') is-invalid @enderror" placeholder="Masukkan Harga Produk">
                                ...
                                <div class="form-group">
                                    <label>Berat</label>
                                    <input type="text" onkeypress="return
hanyaAngka(event)" name="berat" value="{{ old('berat', $edit->berat) }}"
